...
(
    ...
    id_nguoidaidien character(8)[] NOT NULL,
...
(
    id_dichvu character(8)[] NOT NULL,
...
(
    ...
    PRIMARY KEY (id_hopdong, id_phong)
);
...
ALTER TABLE hop_dong ADD CONSTRAINT fk_hopdong_khachhang FOREIGN KEY (id_nguoidaidien) 
	REFERENCES public.khachhang (id_khach) MATCH SIMPLE
	ON UPDATE NO ACTION
	ON DELETE NO ACTION
	NOT VALID;
ALTER TABLE hoa_don ADD CONSTRAINT fk_hoadon_khachhang FOREIGN KEY (id_khach)
	REFERENCES public.khachhang (id_khach) MATCH SIMPLE
	ON UPDATE NO ACTION
	ON DELETE NO ACTION
	NOT VALID;
